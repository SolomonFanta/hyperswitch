...
#[derive(Clone, Copy)]
struct TestconnectorTest;
impl ConnectorActions for TestconnectorTest {}
impl utils::Connector for TestconnectorTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Testconnector;
        api::ConnectorData {
            connector: Box::new(Testconnector::new()),
            connector_name: types::Connector::Testconnector,
...
static CONNECTOR: TestconnectorTest = TestconnectorTest {};
