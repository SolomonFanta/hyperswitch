...
use transformers as testconnector;
...
impl api::Payment for Testconnector {}
impl api::PaymentSession for Testconnector {}
impl api::ConnectorAccessToken for Testconnector {}
impl api::MandateSetup for Testconnector {}
impl api::PaymentAuthorize for Testconnector {}
impl api::PaymentSync for Testconnector {}
impl api::PaymentCapture for Testconnector {}
impl api::PaymentVoid for Testconnector {}
impl api::Refund for Testconnector {}
impl api::RefundExecute for Testconnector {}
impl api::RefundSync for Testconnector {}
impl api::PaymentToken for Testconnector {}
...
impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Testconnector
where
...
impl ConnectorCommon for Testconnector {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.testconnector.base_url.as_ref()
    }
    ...
    fn get_auth_header(&self, auth_type:&ConnectorAuthType)-> CustomResult<Vec<(String,masking::Maskable<String>)>,errors::ConnectorError> {
        let auth =  testconnector::TestconnectorAuthType::try_from(auth_type)
...
impl ConnectorValidation for Testconnector
{
...
impl
    ...
    fn get_request_body(&self, req: &PaymentsAuthorizeRouterData, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_router_data =
            testconnector::TestconnectorRouterData::from((
                amount,
                req,
            ));
        let connector_req = testconnector::TestconnectorPaymentsRequest::try_from(&connector_router_data)?;
    ...
    fn handle_response(
        ...
        let response: testconnector::TestconnectorPaymentsResponse = res.response.parse_struct("Testconnector PaymentsAuthorizeResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
    ...
    for Testconnector
{
    ...
    fn handle_response(
        ...
        let response: testconnector:: TestconnectorPaymentsResponse = res
            .response
            .parse_struct("testconnector PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
    ...
    > for Testconnector
{
    ...
    fn handle_response(
        ...
        let response: testconnector::TestconnectorPaymentsResponse = res
            .response
            .parse_struct("Testconnector PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl
    ...
    fn get_request_body(&self, req: &RefundsRouterData<Execute>, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_req = testconnector::TestconnectorRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: testconnector::RefundResponse = res.response.parse_struct("testconnector RefundResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl
    ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Testconnector {
    ...
    fn handle_response(
        ...
        let response: testconnector::RefundResponse = res.response.parse_struct("testconnector RefundSyncResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl webhooks::IncomingWebhook for Testconnector {
...
impl ConnectorSpecifications for Testconnector {}
