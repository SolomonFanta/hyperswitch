...
use transformers as testconnection;
...
impl api::Payment for Testconnection {}
impl api::PaymentSession for Testconnection {}
impl api::ConnectorAccessToken for Testconnection {}
impl api::MandateSetup for Testconnection {}
impl api::PaymentAuthorize for Testconnection {}
impl api::PaymentSync for Testconnection {}
impl api::PaymentCapture for Testconnection {}
impl api::PaymentVoid for Testconnection {}
impl api::Refund for Testconnection {}
impl api::RefundExecute for Testconnection {}
impl api::RefundSync for Testconnection {}
impl api::PaymentToken for Testconnection {}
...
impl<Flow, Request, Response> ConnectorCommonExt<Flow, Request, Response> for Testconnection
where
...
impl ConnectorCommon for Testconnection {
    ...
    fn base_url<'a>(&self, connectors: &'a Connectors) -> &'a str {
        connectors.testconnection.base_url.as_ref()
    }
    ...
    fn get_auth_header(&self, auth_type:&ConnectorAuthType)-> CustomResult<Vec<(String,masking::Maskable<String>)>,errors::ConnectorError> {
        let auth =  testconnection::TestconnectionAuthType::try_from(auth_type)
    ...
    fn build_error_response(
        ...
        let response: testconnection::TestconnectionErrorResponse = res
            .response
            .parse_struct("TestconnectionErrorResponse")
...
impl ConnectorValidation for Testconnection
{
...
impl
    ...
    fn get_request_body(&self, req: &PaymentsAuthorizeRouterData, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_router_data =
            testconnection::TestconnectionRouterData::from((
                amount,
                req,
            ));
        let connector_req = testconnection::TestconnectionPaymentsRequest::try_from(&connector_router_data)?;
    ...
    fn handle_response(
        ...
        let response: testconnection::TestconnectionPaymentsResponse = res.response.parse_struct("Testconnection PaymentsAuthorizeResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
    ...
    for Testconnection
{
    ...
    fn handle_response(
        ...
        let response: testconnection:: TestconnectionPaymentsResponse = res
            .response
            .parse_struct("testconnection PaymentsSyncResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
    ...
    > for Testconnection
{
    ...
    fn handle_response(
        ...
        let response: testconnection::TestconnectionPaymentsResponse = res
            .response
            .parse_struct("Testconnection PaymentsCaptureResponse")
            .change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
...
impl
    ...
    fn get_request_body(&self, req: &RefundsRouterData<Execute>, _connectors: &Connectors,) -> CustomResult<RequestContent, errors::ConnectorError> {
        ...
        let connector_req = testconnection::TestconnectionRefundRequest::try_from(&connector_router_data)?;
        Ok(RequestContent::Json(Box::new(connector_req)))
    }
    ...
    fn handle_response(
        ...
        let response: testconnection::RefundResponse = res.response.parse_struct("testconnection RefundResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl
    ConnectorIntegration<RSync, RefundsData, RefundsResponseData> for Testconnection {
    ...
    fn handle_response(
        ...
        let response: testconnection::RefundResponse = res.response.parse_struct("testconnection RefundSyncResponse").change_context(errors::ConnectorError::ResponseDeserializationFailed)?;
        event_builder.map(|i| i.set_response_body(&response));
        router_env::logger::info!(connector_response=?response);
        RouterData::try_from(ResponseRouterData {
            response,
...
impl webhooks::IncomingWebhook for Testconnection {
...
impl ConnectorSpecifications for Testconnection {}
