...
#[derive(Clone, Copy)]
struct TestconnectionTest;
impl ConnectorActions for TestconnectionTest {}
impl utils::Connector for TestconnectionTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Testconnection;
        api::ConnectorData {
            connector: Box::new(Testconnection::new()),
            connector_name: types::Connector::Testconnection,
...
static CONNECTOR: TestconnectionTest = TestconnectionTest {};
